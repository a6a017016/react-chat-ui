    ...
    _createClass(BubbleGroup, [{
        ...
        value: function renderGroup(messages, id) {
            ...
            var messageNodes = messages.map(function (message, i) {
                return React.createElement("div", null, React.createElement(antd_1.Avatar, { src: "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png" }), React.createElement(ChatBubble, { key: i, message: message, bubblesCentered: bubblesCentered, bubbleStyles: bubbleStyles }));
            });
            return React.createElement("div", { style: styles_1.default.chatbubbleWrapper }, showSenderName && (senderName || sampleMessage.senderName) !== '' && sampleMessage.id !== 0 && React.createElement("h5", { style: styles_1.default.bubbleGroupHeader }, senderName || sampleMessage.senderName), showSenderName && (senderName || sampleMessage.senderName) !== '' && sampleMessage.id === 0 && React.createElement("div", { style: { overflow: 'auto' } }, React.createElement("h5", { style: styles_1.default.myGroupHeader }, "Me")), messageNodes);
        }
    }, {
        key: "render",
