...
var BubbleGroup = function (_React$Component) {
    ...
    _createClass(BubbleGroup, [{
        ...
        value: function renderGroup(messages, id) {
            ...
            return React.createElement("div", { style: styles_1.default.chatbubbleWrapper }, showSenderName && (senderName || sampleMessage.senderName) !== '' && sampleMessage.id !== 0 && React.createElement("div", null, React.createElement(Avatar_1.default, { style: Object.assign({}, sampleMessage.avatarStyle, { float: 'left', margin: '0 10px' }), src: sampleMessage.avatarSrc || 'https://material-ui.com/static/images/avatar/1.jpg' }), React.createElement("h5", { style: styles_1.default.bubbleGroupHeader }, senderName || sampleMessage.senderName, " - ", sampleMessage.time ? moment(sampleMessage.time).format('hh:mm A') : {})), showSenderName && (senderName || sampleMessage.senderName) !== '' && sampleMessage.id === 0 && React.createElement("div", null, React.createElement(Avatar_1.default, { style: Object.assign({}, sampleMessage.avatarStyle, { float: 'right', margin: '0 10px' }), src: sampleMessage.avatarSrc || 'https://material-ui.com/static/images/avatar/1.jpg' }), React.createElement("h5", { style: styles_1.default.myGroupHeader }, "Me - ", sampleMessage.time ? moment(sampleMessage.time).format('hh:mm A') : {})), messageNodes);
        }
    }, {
        key: "render",
